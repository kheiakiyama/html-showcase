...
// and also the help text which is longer
  ...
  strings_es: {
    ...
    "Table of Contents":"Tabla de Contenidos",
    "restart presentation":"Reiniciar presentacion",
    "restart?":"Inicio"
  },
  help_es:
    "Utilice el raton, barra espaciadora, teclas Izda/Dcha, " +
    "o Re pag y Av pag. Use S y B para cambiar el tamano de fuente.",
  ...
  strings_ca: {
    ...
    "Table of Contents":"Taula de Continguts",
    "restart presentation":"Reiniciar presentacio",
    "restart?":"Inici"
  },
  help_ca:
    "Utilitzi el ratoli, barra espaiadora, tecles Esq./Dta. " +
    "o Re pag y Av pag. Usi S i B per canviar grandaria de font.",
  ...
  help_cs:
    "Prezentaci m??ete prochazet pomoci kliknuti my?i, mezerniku, " +
    "?ipek vlevo a vpravo nebo klaves PageUp a PageDown. Pismo se " +
    "da zv?t?it a zmen?it pomoci klaves B a S.",
  ...
  strings_de: {
    ...
    "Table of Contents":"Inhaltsverzeichnis",
    "restart presentation":"Prasentation neu starten",
    "restart?":"Neustart"
  },
  help_de:
    "Benutzen Sie die Maus, Leerschlag, die Cursortasten links/rechts oder " +
    "Page up/Page Down zum Wechseln der Seiten und S und B fur die Schriftgrosse.",
  ...
  strings_fr: {
    ...
    "Table of Contents":"Table des matieres",
    "restart presentation":"Recommencer l'expose",
    "restart?":"Debut"
  },
  help_fr:
    "Naviguez avec la souris, la barre d'espace, les fleches " +
  ...
  strings_hu: {
    ...
    "Table of Contents":"Tartalomjegyzek",
    "restart presentation":"bemutato ujrainditasa",
    "restart?":"ujrainditas"
  },
  help_hu:
    "Az oldalak kozti lepkedeshez kattintson az egerrel, vagy " +
    "hasznalja a szokoz, a bal, vagy a jobb nyil, illetve a Page Down, " +
    "Page Up billenty?ket. Az S es a B billenty?kkel valtoztathatja " +
    "a szoveg meretet.",
  ...
  strings_el: {
    "slide":"σελ?δα",
    "help?":"βο?θεια;",
    "contents?":"περιεχ?μενα;",
    "table of contents":"π?νακα? περιεχομ?νων",
    "Table of Contents":"Π?νακα? Περιεχομ?νων",
    "restart presentation":"επανεκκ?νηση παρουσ?αση?",
    "restart?":"επανεκκ?νηση;"
  },
  help_el:
    "Πλοηγηθε?τε με το κλ?κ του ποντικιο?, το space, τα β?λη αριστερ?/δεξι?, " +
    "? Page Up και Page Down. Χρησιμοποι?στε τα πλ?κτρα S και B για να αλλ?ξετε " +
    "το μ?γεθο? τη? γραμματοσειρ??.",
  ...
  strings_zh: {
    ...
    "table of contents":"目?",
    "Table of Contents":"目?",
    "restart presentation":"重新??展示",
    "restart?":"重新???"
  },
  help_zh:
    "用鼠?点?, 空格条, 左右箭?, Pg Up 和 Pg Dn ?航. " +
    "用 S, B 改?字体大小.",
  ...
  strings_sv: {
    ...
    "help?":"hjalp",
    "contents?":"innehall",
    "table of contents":"innehallsforteckning",
    "Table of Contents":"Innehallsforteckning",
    "restart presentation":"visa presentationen fran borjan",
    "restart?":"borja om"
  },
  help_sv:
    "Bladdra med ett klick med vanstra musknappen, mellanslagstangenten, " +
    "vanster- och hogerpiltangenterna eller tangenterna Pg Up, Pg Dn. " +
    "Anvand tangenterna S och B for att andra textens storlek.",
